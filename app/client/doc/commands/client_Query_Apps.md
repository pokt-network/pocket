...
Get all the data of all apps

### Synopsis

Queries the node RPC to obtain the paginated data for all apps at the given (or latest if unspecified) height

```
client Query Apps [--height] [--page] [--per_page] [flags]
```
