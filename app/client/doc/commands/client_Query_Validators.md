...
Get all the data of all validators

### Synopsis

Queries the node RPC to obtain the paginated data for all validators at the given (or latest if unspecified) height

```
client Query Validators [--height] [--page] [--per_page] [flags]
```
