...
func (u *utilityContext) calculateAppSessionTokens(appStakeStr string) (string, pokterrors.Error) {
	appStake, er := utils.StringToBigInt(appStakeStr)
	if er != nil {
		return typesUtil.EmptyString, pokterrors.UtilityErrStringToBigInt(er)
	}
