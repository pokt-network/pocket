...
func (u *baseUtilityUnitOfWork) handleByzantineValidators(prevBlockByzantineValidators [][]byte) coreTypes.Error {
...
func (u *baseUtilityUnitOfWork) burnValidator(addr []byte) coreTypes.Error {
