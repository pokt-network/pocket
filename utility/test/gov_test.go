...
func TestUtilityContext_GetAppMaxChains(t *testing.T) {
	...
	require.False(t, int(defaultParams.GetAppMaxChains()) != maxChains, fmt.Sprintf("unexpected param value: expected %v got %v", defaultParams.GetAppMaxChains(), maxChains))
...
func TestUtilityContext_GetAppMaxPausedBlocks(t *testing.T) {
	...
	require.NoError(t, err)
	require.False(t, int(defaultParams.GetAppMaxPauseBlocks()) != gotParam, fmt.Sprintf("unexpected param value: expected %v got %v", defaultParams.GetAppMaxPausedBlocksOwner(), gotParam))
...
func TestUtilityContext_GetAppMinimumStake(t *testing.T) {
	...
	require.NoError(t, err)
	require.False(t, defaultParam != typesUtil.BigIntToString(gotParam), fmt.Sprintf("unexpected param value: expected %v got %v", defaultParam, gotParam))
