...
compose_and_watch: db_start
	docker-compose -f build/deployments/docker-compose.yaml up --force-recreate client pgadmin db node1.consensus node2.consensus node3.consensus node4.consensus
