...
check_cross_module_imports:
	echo "persistence:\n"
	grep --exclude=Makefile --exclude-dir=persistence -r "github.com/pokt-network/pocket/persistence"
	echo "-----------------------"
	echo "utility:\n"
	grep --exclude=Makefile --exclude-dir=utility -r "github.com/pokt-network/pocket/utility"
	echo "-----------------------"
	echo "consensus:\n"
	grep --exclude=Makefile --exclude-dir=consensus -r "github.com/pokt-network/pocket/consensus"
	echo "-----------------------"
	echo "telemetry:\n"
	grep --exclude=Makefile --exclude-dir=telemetry -r "github.com/pokt-network/pocket/telemetry"
	echo "-----------------------"
	echo "p2p:\n"
	grep --exclude=Makefile --exclude-dir=p2p -r "github.com/pokt-network/pocket/p2p"
	echo "-----------------------"
	echo "runtime:\n"
	grep --exclude=Makefile --exclude-dir=runtime -r "github.com/pokt-network/pocket/runtime"
