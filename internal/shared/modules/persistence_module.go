...
//go:generate mockgen -source=$GOFILE -destination=./mocks/persistence_module_mock.go -aux_files=github.com/pokt-network/pocket/internal/shared/modules=module.go

import (
	"github.com/pokt-network/pocket/internal/persistence/kvstore"
