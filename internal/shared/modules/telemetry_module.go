...
//go:generate mockgen -source=$GOFILE -destination=./mocks/telemetry_module_mock.go -aux_files=github.com/pokt-network/pocket/internal/shared/modules=module.go
