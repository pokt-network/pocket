...
func (u *UtilityContext) GetSessionServiceNodesAddressAndServiceURL(chain string, appPublicKey []byte) ([]types2.SessionNode, types2.Error) {
...
func (u *UtilityContext) GetLatestSessionHeight() (sessionBlockheight int64, err types2.Error) {
