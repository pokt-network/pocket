...
func (p *NoopModule) RegisterGauge(name string, description string) { NOOP() }

// Set sets the Gauge to an arbitrary value.
func (p *NoopModule) SetGauge(name string, value float64) { NOOP() }

// Inc increments the Gauge by 1. Use Add to increment it by arbitrary
// values.
func (p *NoopModule) IncGauge(name string) { NOOP() }

// IncGauge(name string)

// // Dec decrements the Gauge by 1. Use Sub to decrement it by arbitrary
// // values.
func (p *NoopModule) DecGauge(name string) { NOOP() }

// // Add adds the given value to the Gauge. (The value can be negative,
// // resulting in a decrease of the Gauge.)
func (p *NoopModule) AddToGauge(name string, value float64) { NOOP() }

// // Sub subtracts the given value from the Gauge. (The value can be
// // negative, resulting in an increase of the Gauge.)
func (p *NoopModule) SubFromGauge(name string, value float64) { NOOP() }
