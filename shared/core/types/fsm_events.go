...
const (
	...
	// StateMachineEvent_Consensus_IsEnableServer  StateMachineEvent = "Consensus_EnableServerMode"
	// StateMachineEvent_Consensus_IsDisableServer StateMachineEvent = "Consensus_DisableServerMode"
