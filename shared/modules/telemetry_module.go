...
//go:generate mockgen -destination=./mocks/telemetry_module_mock.go github.com/pokt-network/pocket/shared/modules TelemetryModule,TimeSeriesAgent,EventMetricsAgent
