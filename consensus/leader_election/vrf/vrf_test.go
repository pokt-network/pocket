...
func TestVRFKeygenProveAndVerifyWithSeed(t *testing.T) {
	...
	vrfOut, vrfProof, err := sk.Prove(msg)
	require.Nil(t, err)
	require.Equal(t, "d4c95d83e26323ec6e86801d810071aefbface10ac59c500e58096f18a72b56c8d9166cfc8252bbb80def11f438d5ce484373f718261555b59eb6f6d9af9370a", hex.EncodeToString(vrfOut))
