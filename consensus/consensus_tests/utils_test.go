...
func P2PBroadcast(nodes map[types2.NodeId]*shared.Node, message consensus_types.GenericConsensusMessage) {
...
func P2PSend(node *shared.Node, message consensus_types.GenericConsensusMessage) {
	m := &consensus_types.ConsensusMessage{
		Message: message,
		Sender:  0,
	}
